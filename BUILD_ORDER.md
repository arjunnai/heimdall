...
| CP3 | Typed mutation boundary, signed approval tokens, policy, append-only audit | In progress |
| CP4 | Streamlit investigation timeline, evidence, Approve/Reject | Pending |
| CP5 | Recruiter-legible README, architecture, screenshots, limitations, v1 verification | Pending |
